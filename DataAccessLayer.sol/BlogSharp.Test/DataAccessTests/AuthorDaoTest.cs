...
public class AuthorDaoTests
{
    ...
    public void Update_UpdatesEmailBlogTitleAndPassword()
    {
        ...
        try
        {
            ...
            var fetchedPreserve = dao.Get(id);
